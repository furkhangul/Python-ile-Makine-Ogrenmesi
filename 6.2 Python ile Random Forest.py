...
#Karar Ağacı Sınıflarının Kullanımı
...
cm = confusion_matrix(y_test,y_pred)
print("DTC için sonuçlar: ",cm)

#Random Forest Sınıflandırmasının Kullanımı 
from sklearn.ensemble import RandomForestClassifier
rfc = RandomForestClassifier(n_estimators=10, criterion='entorpy')

rfc.fit(x_train,y_train)

y_pred = rfc.predict(x_test)
cm = confusion_matrix(y_test,y_pred)
print("RFC için sonuçlar: ",cm)
