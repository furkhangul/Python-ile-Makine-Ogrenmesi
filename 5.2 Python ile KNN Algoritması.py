...
y = veriler.iloc[:, 4].values  # hedef sütun, örneğin "cinsiyet" olabilir
...
#default zaten 5 veriyor ama biz yine yazıyoruz.
#MİNOWSKİ uzaklık hesaplamalarında esas alınacak yöntemi belirtiyor.
