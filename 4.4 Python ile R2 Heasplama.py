...
print("Random Forest için R^2 Değeri:",r2_score(Y,rfr.predict(X)))
#0.97554 değeri en iyi değer olan 1 e çok yakın olduğu için çok iyidir.
print("Decision  Tree için R^2 Değeri:",r2_score(Y,r_dt.predict(X)))
#Decision Tree 1 değerini veiyor yani tam olarak tutturuluyor.
print("Polynomial Regression için R^2 Değeri:",r2_score(Y, lr2.predict(poly_reg1.fit_transform(X))))
#9997 gibi bi değer çıktı bu değer 1e çok ama çok yakın çok iyi test yöntemidir.
